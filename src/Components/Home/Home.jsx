...
import HeroImg from '../../assets/Coffee-img.png'
    ...
    <div className='min-h-[550px] sm:min-h-[600px] bg-brandDark flex justify-center items-center text-white'>
        <div className='container pb-8 sm:pb-0'>
            <div className="grid grid-cols-1 sm:grid-cols-2">
                ...
                <div className='order-2 items-center pl-5 sm:order-1 flex flex-col justify-center gap-6'>
                    <h1 data-aos="fade-up" data-aos-once="true" className='text-5xl sm:text-6xl lg:text-7xl font-bold'>We Serve the finest{"  "} <span data-aos="zoom-out" data-aos-delay="300" className='text-primary font-cursive'>Coffee</span> in the city</h1>
