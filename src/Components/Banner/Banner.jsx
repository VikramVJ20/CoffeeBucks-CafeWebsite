...
import BannerImg from '../../assets/coffee-img2.png'
import BgTexture from '../../assets/Background-Img.jpg'
        ...
        <div className='container min-h-[550px] flex justify-center items-center py-12 sm:py-0'>
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-6'>
                ...
                <div className='flex flex-col justify-center gap-6 sm:pt-0'>
                    ...
                    <p  data-aos="fade-up" className='text-sm text-gray-600 tracking-wide leading-5'>Like the name says its is a blend of premium coffees of arabicas and robustas at a certain ratio. This delicious coffee has milk chocolate and fruity nodes to it</p>
                    <div className='grid grid-cols-2 gap-6'>
                        <div className='space-y-5'>
                            ...
                            <div data-aos="fade-up" data-aos-delay="500" data-aos-offset="0" className='flex items-center gap-3'>
                                <GiFoodTruck className='text-2xl h-12 w-12 shadow-sm p-3 rounded-full bg-yellow-200'/>
                        ...
                        <div data-aos="slide-left" className=' border-l-4 border-primary/50 pl-6 space-y-3'>
                            ...
                            <p className='text-gray-600 text-sm'>{" "} Much like writing code, brewing the perfect cup of coffee requires patience, precision, and a dash of passion to create a comforting blend of flavours</p>
                        </div>
                    </div>
                </div>
            </div>
